...
class OllamaText2Cypher(BaseComponent):
    def __init__(
        self,
        llm: BaseLLM,
    ...
    def construct_cypher(self, question: str, history=[]) -> str:
        ...
        print("The system message has been generated : ", messages)
        ...
        response = requests.post(
            ...
            json={
                ...
                "messages": [
                    {
                        "role": "system",
                        "content": "You are an assistant to help create cypher queries for the question provided , do you best."
                    },
                    {
                        "role": "user",
                        "content": question
        ...
        print("The result json:", response.json())
        print("The ollama output has been recieved : ", message)
        # Extract the content
        content = message.get('content', None)
        print("extracted content is : ", content)
    ...
    def run(
        ...
        print("I reached inside the text2Cypher function")
        final_question = (
            "Question to be converted to Cypher: " + question
            if heal_cypher
            else question
        )
        print("the final question to be converted is is :", final_question)
        ...
        print("The db query returned nothing :" , output)
